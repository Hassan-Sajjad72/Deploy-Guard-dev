...
export const additionalFrameworkFixtures: TopologyFixture[] = [
  ...
  { name: "same-port-next-express", files: { "web/package.json": pkg({ next: "15", react: "19" }, { build: "next build", start: "next start" }), "web/package-lock.json": "{}", ...express("api") }, shape: "SSR_APPLICATION", state: "SUPPORTED" },
