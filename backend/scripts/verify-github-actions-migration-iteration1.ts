...
async function run() {
  ...
  const configValues: Record<string, string> = {
    ...
    DEPLOYGUARD_REUSABLE_WORKFLOW: "Hassan-Sajjad72/Deploy-Guard-dev/.github/workflows/deployguard-reusable.yml@721f63e5e8a3226bc2d0040aa4739328148a90a2",
  };
  const rows: any[] = [];
  const repository = {
  ...
  try {
    ...
    assert.ok(pinnedValidation?.url.endsWith("ref=721f63e5e8a3226bc2d0040aa4739328148a90a2"), "compatibility gate reads the exact immutable SHA");
    ...
    assert.match(workflow, /Hassan-Sajjad72\/Deploy-Guard-dev\/\.github\/workflows\/deployguard-reusable\.yml@721f63e5e8a3226bc2d0040aa4739328148a90a2/);
