...
async function run() {
  ...
  const configValues: Record<string, string> = {
    ...
    DEPLOYGUARD_REUSABLE_WORKFLOW: "Hassan-Sajjad72/Deploy-Guard-dev/.github/workflows/deployguard-reusable.yml@03fb7392cb1178ea60ab1270282d65d9efe3618b",
  };
  const rows: any[] = [];
  const repository = {
  ...
  try {
    ...
    assert.ok(pinnedValidation?.url.endsWith("ref=03fb7392cb1178ea60ab1270282d65d9efe3618b"), "compatibility gate reads the exact immutable SHA");
    ...
    assert.match(workflow, /Hassan-Sajjad72\/Deploy-Guard-dev\/\.github\/workflows\/deployguard-reusable\.yml@03fb7392cb1178ea60ab1270282d65d9efe3618b/);
