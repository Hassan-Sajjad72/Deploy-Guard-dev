...
async function run() {
  ...
  const configValues: Record<string, string> = {
    ...
    DEPLOYGUARD_REUSABLE_WORKFLOW: "Hassan-Sajjad72/Deploy-Guard-dev/.github/workflows/deployguard-reusable.yml@9458571f9c52c9a09dadd1a1d8c5ffa0c74cabd5",
  };
  const rows: any[] = [];
  const repository = {
  ...
  try {
    ...
    assert.ok(pinnedValidation?.url.endsWith("ref=9458571f9c52c9a09dadd1a1d8c5ffa0c74cabd5"), "compatibility gate reads the exact immutable SHA");
    ...
    assert.match(workflow, /Hassan-Sajjad72\/Deploy-Guard-dev\/\.github\/workflows\/deployguard-reusable\.yml@9458571f9c52c9a09dadd1a1d8c5ffa0c74cabd5/);
