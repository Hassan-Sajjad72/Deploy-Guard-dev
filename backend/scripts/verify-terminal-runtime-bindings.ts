...
function verify(mode: "correct" | "http_404" | "http_500" | "template_exception" | "business_error" | "wrong_env" | "wrong_secret" | "wrong_port" | "empty_diagnostics" | "target_converges" | "target_timeout" | "old_target_draining" | "unexpected_target_healthy" | "expected_target_unhealthy") {
  ...
  "ec2 describe-security-groups") printf '%s\n' '{"SecurityGroups":[{"VpcId":"vpc-1","IpPermissions":[{"FromPort":8080,"ToPort":8080,"UserIdGroupPairs":[{"GroupId":"sg-alb"}]},{"FromPort":65535,"ToPort":65535,"UserIdGroupPairs":[{"GroupId":"sg-alb"}]}]}]}' ;;
