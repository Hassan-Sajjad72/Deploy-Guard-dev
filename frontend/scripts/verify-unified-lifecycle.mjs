...
assert.deepEqual(
  ...
  [["source", "passed"], ["build", "running"], ["publish", "waiting"], ["deploy", "waiting"], ["verify", "waiting"], ["finalize", "waiting"]],
);
assert.deepEqual(
  deploymentPhasePresentation({ developerState: "failed_application", progress: { phase: "verify" } }).map((item) => [item.key, item.status]),
  [["source", "passed"], ["build", "passed"], ["publish", "passed"], ["deploy", "passed"], ["verify", "failed"], ["finalize", "waiting"]],
);
assert.deepEqual(
  ...
  [["source", "passed"], ["build", "passed"], ["publish", "passed"], ["deploy", "passed"], ["verify", "passed"], ["finalize", "failed"]],
