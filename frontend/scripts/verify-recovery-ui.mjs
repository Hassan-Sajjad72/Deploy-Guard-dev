...
const canonical = await readFile(new URL("../src/components/projects/CanonicalDeploymentView.jsx", import.meta.url), "utf8");
...
assert.match(canonical, /getProjectDetailedCurrentState/);
assert.match(canonical, /role !== "admin"/);
