...
export default function ProjectTroubleshooting() {
  ...
  return <div className="workspace-page troubleshooting-page">
    ...
    <Card className="troubleshooting-command">
      ...
      {!failedOperations.length ? <p className="muted">No failed operation has both a GitHub Actions run and sanitized persisted failure evidence. Insufficient-evidence operations are intentionally excluded.</p> : null}
    </Card>
