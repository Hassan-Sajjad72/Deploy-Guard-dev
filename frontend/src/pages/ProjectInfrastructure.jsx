...
function SupportingServices({ evidence }) {
  ...
  const cloudWatchAvailable = Boolean(evidence?.runtimeIdentity?.cloudWatchLogGroupName);
  ...
  const services = [
    ...
    ["CloudWatch", cloudWatchAvailable ? "Log identity resolved" : "Unavailable", cloudWatchAvailable],
