...
export default function AdminUsers() {
  ...
  const filteredProjects = projects.filter(({ currentState }) => {
    const state = projectStatePresentation(currentState).state;
    return state !== "DESTROYED" && (projectFilter === "ALL" || state === projectFilter);
  });
